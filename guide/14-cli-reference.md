...
Two paths in `src/index.ts:397-415` bypass `wrap()`:
...
corrupt or version-skewed registry. Source: `src/cli/commands/init.ts:33-74`.
...
Source: `src/cli/commands/init-agent.ts:230-308` and `src/cli/commands/agent/register-commands.ts`.
...
programmatically as defense-in-depth (`src/cli/commands/skill/register.ts:38-46`).
...
mode. Source: `src/cli/commands/skill/install-cmd.ts:221-264`.
...
with no remaining installs. Source: `src/cli/commands/skill/install-cmd.ts:266-282`.
...
removed. Source: `src/cli/commands/daemon.ts:105-218` (`daemonStartImpl` + `daemonStart`).
...
`src/cli/commands/daemon.ts:220-346` (`daemonStop` + `daemonStopImpl`).
...
Source: `src/cli/commands/daemon.ts:348-498` (`daemonStatus` + `daemonStatusImpl`).
...
defaults in force (`src/index.ts:380-388`).
