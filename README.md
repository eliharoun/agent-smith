...
- `agent.config.json` — targets, model tier, mode, permissions, MCP servers, skills, knowledge sources (files, web pages, wikis, and external tools your agent can read)
