...
// Note: picocolors auto-detects TTY and disables ANSI in test/non-TTY environments,
// so test assertions can use plain substrings and not worry about escape sequences.
